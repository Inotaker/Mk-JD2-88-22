...
public class HibernateFlightsStorage implements IFlightsStorage {
    private static HibernateFlightsStorage instance = new HibernateFlightsStorage();
    private final ObjectMapper mapper = new ObjectMapper();
    private final DataSource dataSource;

    public HibernateFlightsStorage() {
    ...
    public static HibernateFlightsStorage getInstance() {
        return instance;
    }
}
